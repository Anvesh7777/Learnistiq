        ...
        <header className='flex items-center justify-between p-6 bg-white dark:bg-[#1a1a1a] shadow-md'>
          <div className='flex items-center space-x-2'>
            <Link to="/" className="flex items-center space-x-2">
              ...
              <span className="text-2xl font-bold text-white">Learnistiq
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg">
        ...
        <section class="max-w-5xl mx-auto px-4 py-16">
          <h2 class="text-4xl font-extrabold text-center text-white mb-10">Frequently Asked Questions</h2>

          <div class="space-y-4">
            <details class="border border-gray-200 rounded-xl p-4">
              <summary class="text-lg font-semibold cursor-pointer text-gray-200 flex justify-between items-center">
                What is Learnistiq?
